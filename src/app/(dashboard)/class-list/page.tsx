                ...
                <form action="#" className="d-flex flex-column p-20">
                    <div className="row g-3">
                        <div className="col-sm-12">
                            <div className="">
                                <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                                    Name
                                </label>
                                <input type="text" className="form-control" id="sectionName" placeholder="Enter Class name" />
                            </div>
                        </div>
                        <div className="col-sm-12">
                            <div className="">
                                <label htmlFor="selectSectionTwo" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                                </label>
                                <select id="selectSectionTwo" className="form-control form-select">
            ...
            <div
                ...
                <form action="#" className="d-flex flex-column p-20">
                    <div className="row g-3">
                        <div className="col-sm-12">
                            <div className="">
                                <label htmlFor="sectionNameEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Class
                                    Name
                                </label>
                                <input type="text" className="form-control" id="sectionNameEdit" placeholder="Enter section name" />
                            </div>
                        </div>
                        <div className="col-sm-12">
                            <div className="">
                                <label htmlFor="selectSectionEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                                </label>
                                <select id="selectSectionEdit" className="form-control form-select">
                                    <option value="Select a class" selected disabled>Select Section</option>
                                    <option value="A">A</option>
                                    <option value="B">B</option>
                                    <option value="C">C</option>
