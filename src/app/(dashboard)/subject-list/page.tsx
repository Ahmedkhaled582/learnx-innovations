          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                              Name
                          </label>
                          <input type="text" className="form-control" id="sectionName" placeholder="Enter subjects name" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="subjectCode" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                              Code
                          </label>
                          <input type="text" className="form-control" id="subjectCode" placeholder="Enter subjects code" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                     ...
                     <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="subjectCodeTwoEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Subjects
                              Code
                          </label>
                          <input type="text" className="form-control" id="subjectCodeTwoEdit" placeholder="Enter subjects code" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
