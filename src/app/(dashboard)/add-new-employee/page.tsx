  ...
  return (
    <>
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <a href="/add-new-employee" className="btn btn-primary-600 d-flex align-items-center gap-6 d-none">
                  ...
                  <div className="row gy-3">
                          ...
                          <div className="shadow-1 radius-12 bg-base h-100 overflow-hidden">
                              ...
                              <div className="card-body p-20">
                                  <div className="row gy-3">
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              <label htmlFor="employeeID"
                                                  className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Employee
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              <label htmlFor="employeeDepartment"
                                                  className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Department
                                              </label>
                                              <select id="employeeDepartment" className="form-control form-select">
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              <label htmlFor="employeeDesignation"
                                                  className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Designation
                                              </label>
                                              <select id="employeeDesignation" className="form-control form-select">
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              <label htmlFor="employeeShift"
                                                  className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Shift</label>
                                              <select id="employeeShift" className="form-control form-select">
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              <label htmlFor="employeeEmails"
                                                  className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Email
                                                  <span className="text-danger-600">*</span> </label>
                                              <input type="text" className="form-control" id="employeeEmails"
                          ...
                          <div className="shadow-1 radius-12 bg-base h-100 overflow-hidden">
                              ...
                              <div className="card-body p-20">
                                  <div className="row gy-3">
                                      ...
                                      <div className="col-sm-6">
                                          <div className="">
                                              <label className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Upload
                                                  File</label>
                                              <div
                                                  className="drop-zone height-44-px p-4 d-flex justify-content-center align-items-center text-center fw-medium text-md cursor-pointer border border-neutral-400 radius-8 border-dashed bg-hover-neutral-200">
                                                  <span className="drop-zone__prompt">Darg & drop a file here or click</span>
                      ...
                      <div className="col-xl-12">
                          <div className="shadow-1 radius-12 bg-base h-100 overflow-hidden">
                              <div
                                  className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center justify-content-between">
                                  <h6 className="text-lg fw-semibold mb-0">Employee Details</h6>
                              </div>
                              <div className="card-body p-20">
                                  <div className="row gy-3">
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              ...
                                              <input type="text" id="facebookLink" className="form-control"
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              ...
                                              <input type="text" id="linkedInLink" className="form-control"
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              ...
                                              <input type="text" id="instagramLink" className="form-control"
                                      ...
                                      <div className="col-xxl-3 col-xl-4 col-sm-6">
                                          <div className="">
                                              ...
                                              <input type="text" id="youTubeLink" className="form-control"
