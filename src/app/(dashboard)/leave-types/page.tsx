  ...
  return (
    <>
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                  <div className="">
                      <h1 className="fw-semibold mb-4 h6 text-primary-light">Leave Types</h1>
                      <div className="">
                          <a href="/" className="text-secondary-light hover-text-primary hover-underline">Dashboard </a>
                          <span className="text-secondary-light">/ Leave Types</span>
                      </div>
                  </div>
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Leave Types
                          </label>
                          <input type="text" className="form-control" id="sectionName" placeholder="Enter Fees Type name" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                     <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionNameTwo" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees Type
                          </label>
                          <input type="text" className="form-control" id="sectionNameTwo" placeholder="Enter Fees Type name" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionStatusTwoo" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                          </label>
                          <select id="sectionStatusTwoo" className="form-control form-select">
                              <option value="Select a subject" selected disabled>Select Status</option>
                              <option value="Active">Active</option>
                              <option value="Inactive">Inactive</option>
                          </select>
