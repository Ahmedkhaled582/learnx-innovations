  ...
  return (
    <>
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                  <div className="">
                      <h1 className="fw-semibold mb-4 h6 text-primary-light">Languages </h1>
                      <div className="">
                          ...
                          <a href="/employee-list" className="text-secondary-light hover-text-primary hover-underline "> /
                              Settings</a>
                          <span className="text-secondary-light">/ Languages</span>
                      </div>
                  </div>
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Add Language</h5>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="languageName"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Language Name
                          </label>
                          <input type="text" className="form-control" id="languageName" placeholder="Enter Language Name" />
                      </div>
                  </div>
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Edit Language </h5>
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                   <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="languageNameEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Language Name
                          </label>
                          <input type="text" className="form-control" id="languageNameEdit" placeholder="Enter Language Name" />
                      </div>
                  </div>
                  <div className="col-12">
                      <div className="d-flex align-items-center justify-content-center gap-3 mt-8">
