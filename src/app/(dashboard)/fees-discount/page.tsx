    ...
    <>
                                          ...
                                          <td>
                                              <div className="btn-group">
                                                  ...
                                                  <ul className="dropdown-menu dropdown-menu-lg-end border p-12">
                                                      ...
                                                      <li><button
                                                              className="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6"><i
                                                                  className="ri-error-warning-line"></i>Activate</button></li>
                                                      <li><button
                                                              className="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900 d-flex align-items-center gap-2 py-6"><i
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Add New Discount</h5>
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Group
                              Name
                          </label>
                          <input type="text" className="form-control" id="sectionName" placeholder="Enter Group Name" />
                      </div>
                  </div>
                  <div className="col-sm-6">
                      <div className="">
                          <label htmlFor="discountType"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Type</label>
                          <select id="discountType" className="form-control form-select">
                  ...
                  <div className="col-sm-6">
                      <div className="">
                          <label htmlFor="discountValue"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Value </label>
                          <input type="text" className="form-control" id="discountValue" placeholder="Ex: 10%" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionNameEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Group
                              Name
                          </label>
                          <input type="text" className="form-control" id="sectionNameEdit" placeholder="Enter Group Name" />
                      </div>
                  </div>
                  <div className="col-sm-6">
                      <div className="">
                          <label htmlFor="discountTypeEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Type</label>
                          <select id="discountTypeEdit" className="form-control form-select">
                              <option value="Percentage" selected>Percentage</option>
                              <option value="Percentage">Percentage</option>
                          </select>
                      </div>
                  ...
                  <div className="col-sm-6">
                      <div className="">
                          <label htmlFor="discountValueEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Discount Value </label>
                          <input type="text" className="form-control" id="discountValueEdit" placeholder="Ex: 10%" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
