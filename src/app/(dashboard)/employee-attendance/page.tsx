                                              ...
                                              <div className="row g-3">
                                                  <div className="col-6">
                                                      <label htmlFor="departments"
                                                          className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Departments</label>
                                                      <select id="departments" className="form-control form-select">
                                                  ...
                                                  <div className="col-6">
                                                      <label htmlFor="designation"
                                                          className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Designation</label>
                                                      <select id="designation" className="form-control form-select">
