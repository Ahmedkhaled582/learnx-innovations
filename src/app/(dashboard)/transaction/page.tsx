    ...
    <>
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Add Transaction </h5>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="transactionType"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Transaction Type
                          </label>
                          <input type="text" className="form-control" id="transactionType" placeholder="Enter Transaction Type" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="paymentType" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Payment
                              Type
                          </label>
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="transactionTypeEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Transaction Type
                          </label>
                          <input type="text" className="form-control" id="transactionTypeEdit"
                              placeholder="Enter Transaction Type" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="paymentTypeEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Payment Type
                          </label>
                          <input type="text" className="form-control" id="paymentTypeEdit" placeholder="Enter Payment Type" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
