    ...
    <>
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Add Role & Access</h5>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="roleName"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Role Name
                          </label>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="enterDate"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                          </label>
                          <input type="date" className="form-control" id="enterDate" />
                      </div>
                  </div>
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="enterDateEdit"
                              className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Date
                          </label>
                          <input type="date" className="form-control" id="enterDateEdit" />
                      </div>
                  </div>
                  <div className="col-12">
                      <div className="d-flex align-items-center justify-content-center gap-3 mt-8">
