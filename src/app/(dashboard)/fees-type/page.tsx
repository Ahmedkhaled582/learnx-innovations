          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees Name
                          </label>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionStatusTwo" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                          </label>
                          <select id="sectionStatusTwo" className="form-control form-select">
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                     <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionNameTwo" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees Name
                          </label>
