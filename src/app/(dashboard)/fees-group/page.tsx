      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="feesType" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                              Type</label>
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="feesTypeEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Fees
                              Type</label>
                          <select id="feesTypeEdit" className="form-control form-select">
                              <option value="Select fees type" selected disabled>Select fees type</option>
                              <option value="May month fees">May month fees</option>
                              <option value="Admission fees">Admission fees</option>
                              <option value="Exam fees">Exam fees</option>
                  ...
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionStatusTwoHere" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Status
                          </label>
                          <select id="sectionStatusTwoHere" className="form-control form-select">
                              <option value="Select a subject" selected disabled>Select Status</option>
                              <option value="Active">Active</option>
                              <option value="Inactive">Inactive</option>
                          </select>
