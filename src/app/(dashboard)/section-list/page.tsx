          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionName" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                              Name
                          </label>
                          <input type="text" className="form-control" id="sectionName" placeholder="Enter section name" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
      ...
      <div
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="sectionNameEdit" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Section
                              Name
                          </label>
