    ...
    <>
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Add Notice</h5>
          ...
          <form action="#" className="d-flex flex-column p-20">
              <div className="row g-3">
                  <div className="col-sm-12">
                      <div className="">
                          <label htmlFor="myTitle" className="text-sm fw-semibold text-primary-light d-inline-block mb-8">Title
                          </label>
                          <input type="text" className="form-control" id="myTitle" placeholder="Enter title" />
                      </div>
                  </div>
                  <div className="col-sm-12">
                      <div className="">
      ...
      <div
          ...
          <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
              <h5 className="text-lg mb-0">Edit Notice </h5>
