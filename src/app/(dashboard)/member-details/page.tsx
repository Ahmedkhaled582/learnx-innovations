                      ...
                      <div className="card-body p-24">
                          <div className="d-flex gap-32 flex-md-row flex-column">
                              <div className="max-w-300-px w-100 text-center">
                                  ...
                                  <h2 className="h6 text-primary-light mb-4 fw-semibold">Seth Hallam</h2>
                  ...
                  <div className="my-16">
                      <div className="shadow-1 radius-12 bg-base h-100 overflow-hidden">
                          <div className="card-header bg-base py-10 px-20 d-flex align-items-center justify-content-between">
                              ...
                              <button type="button"
                                  className="my-sidebar-btn btn btn-primary-600 d-flex align-items-center gap-6 py-8 text-sm">
                          ...
                          <div className="card-body p-0 dataTable-wrapper">
                              ...
                              <table className="table bordered-table mb-0 table-heading-dark-mode w-100 data-table" id="dataTable"
                                  data-page-length='10'>
                                  <thead>
                                      <tr>
                                          <th scope="col">
