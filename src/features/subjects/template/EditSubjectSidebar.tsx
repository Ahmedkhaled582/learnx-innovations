...
import { UpdateSubjectPayload } from "../api/subjectsApi";

interface EditSubjectSidebarProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (e: React.FormEvent) => void;
  formState: UpdateSubjectPayload;
  onChange: (state: UpdateSubjectPayload) => void;
  isPending: boolean;
}

export function EditSubjectSidebar({
  isOpen,
  onClose,
  onSubmit,
  formState,
