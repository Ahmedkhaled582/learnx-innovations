...
import { UpdateClassRoomPayload } from "../api/classRoomApi";

interface EditClassRoomSidebarProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (e: React.FormEvent) => void;
  formState: UpdateClassRoomPayload;
  onChange: (state: UpdateClassRoomPayload) => void;
  isPending: boolean;
}

export function EditClassRoomSidebar({
  isOpen,
  onClose,
  onSubmit,
  formState,
