...
interface EditCategorySidebarProps {
  isOpen: boolean;
  onClose: () => void;
...
export function EditCategorySidebar({
  isOpen,
  onClose,
  onSubmit,
  register,
  ...
  return (
    ...
    >
      <div className="px-20 py-12 border-bottom d-flex align-items-center justify-content-between gap-20">
        <h5 className="text-lg mb-0">Edit Student Category</h5>
        <button
          type="button"
          onClick={onClose}
      ...
      <form onSubmit={onSubmit} className="d-flex flex-column p-20">
        <div className="row g-3">
          <div className="col-sm-12">
            <div>
              <label
                htmlFor="studentCategoryNameEdit"
          ...
          <div className="col-sm-12">
            <div>
              <label
                htmlFor="studentStatusEdit"
                className="text-sm fw-semibold text-primary-light d-inline-block mb-8"
              >
                Status
              </label>
              <select
                id="studentStatusEdit"
